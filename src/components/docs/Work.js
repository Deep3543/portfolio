                ...
                <div className="work-content">
                    ...
                    <ul className="work-cards">
                            ...
                            <div className="card-overlay">
                                ...
                                <div className="card-description">
                                    <p className="work-details">
                                        An online LaTeX text-editor web
                                        application for PhD students and
                                        lecturers/
                                    </p>
                                    <button className="work-source">
                        ...
                        <li className="work-card">
                            ...
                            <img
                                src={Work2}
                                alt="DeakinTrack Application Prototype"
                                className="card-img"
                            />
                            <div className="card-overlay">
                                <div className="card-header">
                                ...
                                <div className="card-description">
                                    <p className="work-details">
                                        An android application for Deakin
                                        University students|staff for easy
                                        navigation/
                                    </p>
                                    <button className="work-source">
                                        <span className="button-desc">
